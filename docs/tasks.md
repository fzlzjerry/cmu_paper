...
| E13 | Pilot scan | E12 PASS; Phase 13B PASS | immutable randomized samples; QC; provisional knees; pilot gate | ready for one completely new campaign: Decision 0030 successor admissions pass B=1/4/8 for all nine compressed configurations; the stopped 810-record campaign remains immutable and must not be resumed |
