...
| E13 | Pilot scan | E12 PASS; Phase 13B PASS | immutable randomized samples; QC; provisional knees; pilot gate | blocked: fresh campaign `phase13-20260801t184243094922z-e886592f-99b6ca` preserved all 810 records but stopped after 14 completed runs when precomputed-feasible `tq_3bit_nc` B=8/L=98304 exhausted memory during prefix construction; requires separate peak-memory feasibility remediation and another wholly new campaign; neither stopped campaign may resume |
...
- Phase 4 adds only the BF16 adapter/factory and reusable admission facades.
  ...
  E13's stopped campaign remains immutable and durably retrieved; no timing
  point completed. Phase 13B separately admits B=1/4/8 static geometry for all
  nine compressed configurations. A new Pilot requires a fresh campaign ID;
  Phase 14, performance profiling, Full Scan, and quality execution remain
  unopened.
